 ...
 **
 ** This version is identical to "rgbw-pwm-dimmer.ino" but demonstates
 ** the alternate method of using a callback function that is invoked
 ** whenever there is new DMX data.
 **
...
void setup() {
  ...
  WifiDMX::setup_with_callback(WLAN_SSID, WLAN_PASSWORD, DMX_UNIVERSE, pwmDimmerUpdateFunction, ALL_PACKET_DEBUG);
} // setup()
